export default {
    ...
    pkt_cash: {
        cash_title: "PKT Cash is currency for bandwidth",
        cash_text: "Miners are paid in PKT by running the PacketCrypt proof-of-work. This delivers the economic incentive for miners to support the network and powers the PKT blockchain. The PKT Cash cryptocurrency is designed for microtransactions with near-instant settlement and near-zero gas fees. The intent is for PKT Cash to eventually power a decentralized bandwidth-trading marketplace.",
        cash_chess_title: "PKT Cash Use Cases",
        cash_simple_title: "PKT Cash is a utility coin",
        cash_simple_text: "PKT Cash is the fuel powering the PKT ecosystem. Utility includes payments for internet access, high speed VPN and e-commerce use cases. With PKT Lightning Network integration coming soon, website operators can build PKT Network websites and receive PKT payments directly to their IPv6 website URL. This eliminates the need for third party payment processors and delivers near-infinite transactions per second and near-instant settlement.",
        cash_chess_title_1: "PKT VPN",
        cash_chess_descr_1: "PKT VPN uses peer-to-peer cjdns technology. It ensures a fully decentralized service, featuring end-to-end encrypted data transmission and connectivity. Leveraging the strengths of mesh networking, PKT VPN is a robust, trustless alternative to traditional VPN services, which also opens access to the PKT Network.",
        cash_chess_title_2: "PKT Websites",
        cash_chess_descr_2: "Anyone can host websites within the PKT Network using cjdns. All PKT websites are censorship-resistant and reachable within the PKT Network. Website hosts can also use a reverse-VPN feature so content is accessible from the public internet. PKT websites can use their IPv6 web URL as a PKT payment address for payment processing.",
        cash_chess_title_3: "PacketCrypt",
        cash_chess_descr_3: "PacketCrypt is the world’s first bandwidth-hard proof-of-work. Like all proof-of work-algorithms, PacketCrypt uses computational power to solve a mathematical problem. Uniquely, the PacketCrypt problem solving becomes easier when miners work together to solve it by sending data between each other, which requires bandwidth.",
        cash_chess_title_4: "TokenStrike",
        cash_chess_descr_4: "TokenStrike is a forthcoming token standard that simplifies the issuing of cryptocurrency tokens. Each TokenStrike token supply will be its own blockchain, so transaction settlement is not dependent on the core PKT blockchain. This ensures limitless scalability and a foundation for supporting decentralized bandwidth trading marketplaces.",
        cash_chess_title_5: "Bandwidth Marketplaces",
        cash_chess_descr_5: "Roadmap development includes a DEX-like marketplace where decentralized internet operators (Cloud ISPs) can buy and sell tokens that represent bandwidth-leases. Cloud ISPs will acquire bandwidth leases and stitch together internet service infrastructure. Contributors (Edge Points) will sell bandwidth leases and monetize bandwidth.",
    ...
    mine: {
        mine_title: "How to mine PKT",
        mine_text: "The PKT Network is powered by miners who run PacketCrypt, the world’s first and only bandwidth-hard, proof of work, mining algorithm. PacketCrypt economically incentivizes miners to collaborate, operate and grow the fully decentralized PKT Network. Mining has never been easier. Get started today.",
        mine_button_1: "Get a Mining Wallet",
        mine_button_2: "Download Minr",
        mine_button_3: "Read Docs",
        mine_links_title_1: "Start PKT mining",
        mine_links_text_1: "View PKT mining instructions, requirements, and FAQ related to using a PKT mining app. Or install PacketCrypt directly from Github.",
        mine_links_link_1: "Get started",
        mine_links_title_2: "Blockchain Explorer",
        mine_links_text_2: "View PKT blocks, pools, transactions, addresses, balances, network steward wallet and more.",
        mine_links_link_2: "View explorer",
        mine_links_title_3: "Setup a PKT mining pool",
        mine_links_text_3: "PKT mining pools require technical operators with substantial bandwidth and processing infrastructure to validate blocks.",
        mine_links_link_3: "Learn more",
        mine_links_title_4: "Install a PKT miner",
        mine_links_text_4: "Begin PKT mining using the PKT World wallet or with the Minr app for MacOS, Linux or Windows.",
        mine_links_link_4: "Read docs",
        mine_chess_title_1: "Why Mine PKT?",
        mine_chess_subtitle_1: "Mining is the backbone of the PKT Network",
        mine_chess_descr_1: "Mining requires bandwidth and CPU power, which encrypts the network and establishes its high speed data infrastructure. When PKT Lightning Network launches, its near-infinite transactions per second and near-instantaneous settlement will make PKT one of the highest throughput blockchains in the world.",
        mine_chess_title_2: "How to Mine PacketCrypt?",
        mine_chess_subtitle_2: "Bandwidth + CPU",
        mine_chess_descr_2: "PacketCrypt can be easily mined from any CPU powered device. PKT mining pools are community powered and require significant bandwidth resources. Miners and PKT mining pools are incentivized to collaborate, which decentralizes the network infrastructure and propagates the network.",
        meta_title: "Mine - PKT",
        meta_descr: "The world’s first bandwidth-hard blockchain protocol, built to incentivize the growth of infrastructure.",
        title: "PKT Mining",
    ...
    steward: {
        steward_title: "Network Steward Governance and Grants",
        steward_text: "The Network Steward is a wallet address that earns 20% from every mined block to fund the ongoing development of the PKT Network. The custodian of the Network Steward wallet is democratically elected weekly by proof-of-stake voting.",
        steward_button_1: "View voting",
        steward_button_2: "View wallet",
        steward_charter_title: "The Network Steward Charter",
        steward_charter_inner_1: "The Network Steward is designed to give all PKT community members a say in the network governance. Using a proof-of-stake voting system, a weekly election determines the Network Steward. In order for a candidate to remain the Network Steward, they must be re-elected every week. This current governance mechanism is live beta.",
        steward_charter_inner_2: "The objective of the Network Steward is for the network to self fund the development of the roadmap, network maintenance and community growth. The community should elect candidates that are motivated to benefit the project and whose agenda is deemed beneficial by the majority of the electorate. Historically, the Network Steward has had 129,600 blocks (approximately 3 months) to deploy the oldest coins in the wallet or those coins are burned. To date, more than 14% of the mined coins have been burned. The new governance system better ensures the Network Steward funds are purposefully deployed to support the PKT project and network.",
        steward_grants_title: "Project Grants",
        steward_grants_data_title_1: "PKT x VPN",
        steward_grants_data_text_1: "This project is to build VPN infrastructure that powers the PKT Network and leverages cjdns exit nodes for VPN access points.",
        steward_grants_data_title_2: "PKT x TokenStrike",
        steward_grants_data_text_2: "Developing a protocol for the issuance of tokens, where token supply is its own blockchain. This ensures limitless scalability of the PKT ecosystem.",
        steward_grants_data_title_3: "PKT x NLnet",
        steward_grants_data_text_3: "NLnet is a not-for-profit philanthropic organization providing micro-grants towards projects deemed relevant for the PKT ecosystem.",
        steward_grants_link: "View Github",
        steward_governance_title: "Governance By the Community",
        steward_governance_text: "It is the belief of the PKT founding community members that any unaccountable authority, no matter how benevolent, will eventually fall victim to corruption, inefficiency or simple failure to innovate. To solve this, PKT holders elect the Network Steward on a weekly basis. Voters can choose to delegate their vote so another party votes on their behalf.",
    ...
    goodnews: {
        good_news: "Project Good News",
        title_1: "Project",
        title_2: "GOOD NEWS",
        title_3: "Announcement 3 of 7",
        counter_1: "Days",
        counter_2: "Hours",
        counter_3: "Mins",
        counter_4: "Secs",
    ...
    pkt_network: {
        ...
        assym_title: "PKT’s Integrated Payment Rails",
        simple_title: "What is PKT Network?",
        simple_text: "PKT Network is an decentralized ecosystem powered by the people. Contributors are earn PKT 	cryptocurrency by connecting bandwidth and computer processing resources to power the network. The result is a secure, high speed, permissionless, user-operated web infrastructure. Websites built in the PKT Network are censorship-resistant, yet reachable from any web browser using a reverse VPN and payments can be paid directly to a web URL within the network.",
        assym_1_title: "Peer-to-peer Payments",
        assym_1_text: "Link a cjdns IPv6 address to a PKT wallet address and seamlessly receive payments without a third party payment processor.",
        assym_2_title: "No Fees",
        assym_2_text: "Enjoy near-zero gas fees and no third party payment processor fees when using PKT’s payment rails.",
        assym_second_1_title: "Scalable",
        assym_second_1_text: "Upon PKT Lightning Network launch, PKT will have near-infinite transactions per second for unlimited scalability.",
        assym_second_2_title: "Layer-2 Payment Rails",
        assym_second_2_text: "PKT Lighting Network  is a fork of Bitcoin’s layer-2 Lightning Network. Payments will soon process over PKT Lighting Network offering near-instant settlement.",
        meta_title: "Scaling the PKT Network - PKT",
    },
    dev_central: {
        ...
        button_2: "Read docs",
        block_1_title: "Install a cjdns node",
        block_1_text: "When you install cjdns you are adding core physical infrastructure to the VPN-based PKT Network.",
        block_2_title: "Begin mining PKT",
        block_2_text: "Mining can be done from any computer. The PKT World wallet has a miner built-in, so it’s easy to participate.",
        block_3_title: "Setup a PKT mining pool",
        block_3_text: "PKT mining pools require skilled operators with substantial bandwidth and bare metal infrastructure.",
        block_4_title: "Run a PKT FullNode",
        block_4_text: "Each PKT FullNode validates the blocks and helps the wallets to receive and send PKT.",
        block_5_title: "PKT Lightning Network",
        block_5_text: "PKT Lightning Network is designed to fortify the speed and portability of transactions across the PKT Network.",
        block_6_title: "Build a website in PKT Network",
        block_6_text: "Get more information about building and hosting censorship-resistant websites in the PKT Network.",
        block_button_1: "Install now",
        block_button_2: "Get started",
        simple_text: "PKT is permissionless, so everyone is empowered to develop the project. Get started by either mining PacketCrypt or installing a cjdns node. These efforts are the infrastructure of the PKT Network. PKT Network supports censorship-resistant websites. These sites can be reached peer-to-peer within the PKT Network, or from the global internet using a reverse VPN. If funding is needed, check out the Network Steward, which is a grant mechanism to fund PKT-related projects.",
        meta_title: "Developer Central - PKT",
    },
    wallets: {
        title: "PKT Wallets",
        ...
        watchr_title_1: "Watch any wallet on the",
        watchr_title_2: "PKT blockchain",
        watchr_text: "Watchr enables you to get insights and track any wallet address using the mobile or desktop app.",
        pkt_wallets_1_heading: "Desktop Wallet",
        pkt_wallets_1_title: "PKT World Wallet",
        pkt_wallets_1_content: "Windows and MacOS wallet with built-in PKT miner",
        pkt_wallets_2_heading: "iOS Mobile Wallet",
        pkt_wallets_2_title: "Anode Mobile Wallet",
        pkt_wallets_2_content: "Mobile wallet for iOS with PKT Lightning for micro-transactions",
        pkt_wallets_3_heading: "Android Mobile Wallet",
        pkt_wallets_3_title: "Anode VPN for Android",
        pkt_wallets_3_content: "Android mobile wallet that includes built-in PKT VPN app",
        mining_wallets_1_heading: "PKT Mining Wallet",
        mining_wallets_1_title: "PKT World Wallet",
        mining_wallets_1_content: "Windows and MacOS wallet with built-in PKT miner",
        mining_wallets_2_heading: "PKT Mining Wallet",
        mining_wallets_2_title: "Command Line PKT Wallet",
        mining_wallets_2_content: "This terminal-based wallet is a full node setup",
        mining_wallets_3_heading: "WPKT Wallet",
        mining_wallets_3_title: "WPKT MetaMask",
        mining_wallets_3_content: "Use this wallet for WPKT only on web browser and mobile",
    }
}